...
const ThemeToggle = () => {
  ...
  const updateThemeVariables = (darkMode: boolean) => {
    const root = document.documentElement;
    
    if (darkMode) {
      root.style.setProperty('--color-background', '#050505');
      root.style.setProperty('--color-text', '#f9fafb');
      root.style.setProperty('--color-text-secondary', 'rgba(249, 250, 251, 0.8)');
      root.style.setProperty('--color-text-muted', 'rgba(249, 250, 251, 0.6)');
      ...
      root.style.setProperty('--color-text-secondary', 'rgba(26, 26, 26, 0.8)');
      root.style.setProperty('--color-text-muted', 'rgba(26, 26, 26, 0.6)');
