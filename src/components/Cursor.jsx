...
const Cursor = () => {
  ...
  const cursorRingsRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const handleMagneticMove = (e, elem) => {
    ...
    const handleMagneticLeave = (elem) => {
      gsap.to(elem, {
        x: 0,
        y: 0,
        duration: 0.3,
    ...
    const setupMagneticElements = () => {
      ...
      magneticElements.forEach(elem => {
        elem.addEventListener('mousemove', (e) => handleMagneticMove(e, elem));
