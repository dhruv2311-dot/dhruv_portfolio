...
const Projects = () => {
  ...
  useEffect(() => {
    ...
    if (filter === "All") {
      newFilteredProjects = projectsData;
    } else {
      newFilteredProjects = projectsData.filter(project => 
    ...
    if (projectsRef.current && filteredProjects.length > 0) {
      const currentCards = projectsRef.current.querySelectorAll('.project-card');
      ...
      gsap.to(currentCards, {
        ...
        onComplete: () => {
          ...
          // Fade in new cards after a short delay
          setTimeout(() => {
            const newCards = projectsRef.current?.querySelectorAll('.project-card');
            if (newCards) {
  ...
  return (
    <section ref={sectionRef} id="projects" className="relative overflow-hidden py-20">
      ...
      <div className="container mx-auto px-6">
            ...
            <button 
              ...
              className={`px-4 py-2 rounded-full border-2 transition-all duration-300 magnetic-hover ${
                filter === category 
                  ...
                  : 'bg-transparent hover:border-[var(--color-secondary)]'
              }`}
        ...
        {/* Projects grid with fixed height container */}
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-[var(--color-surface)] h-full transform transition-transform duration-500 hover:scale-[1.02]">
                  ...
                  <div className="p-6">
                    ...
                    <p className="mb-4 line-clamp-3" style={{ color: 'var(--color-text-secondary)' }}>{project.description}</p>
